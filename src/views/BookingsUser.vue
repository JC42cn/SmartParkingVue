  ...
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-table-column prop="state" label="预约状态">
        ...
        <el-table-column label="操作" width="300" v-else>
          <template #default="scope">
            <el-button type="danger" @click="cancelbookings(scope.row)" v-if="scope.row.state === 0">取消预约</el-button>
            <el-button type="info" @click="startTimer(scope.row)" v-if="scope.row.state===0">查看剩余时间</el-button>
          </template>
        </el-table-column>
